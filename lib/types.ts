...
export const METRIC_DEFINITIONS: MetricDefinition[] = [
  ...
  { id: "lower_third", name: "Lower Third", category: "Facial Thirds", idealMin: 30.0, idealMax: 33.0, unit: "%", description: "Subnasale to menton as % of trichion-to-menton height", isDetectable: true },
