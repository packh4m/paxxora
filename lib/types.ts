...
export const METRIC_DEFINITIONS: MetricDefinition[] = [
  ...
  { id: "lower_third", name: "Lower Third", category: "Facial Thirds", idealMin: 33.9, idealMax: 37.0, unit: "%", description: "Subnasale to menton as % of trichion-to-menton height", isDetectable: true },
  { id: "face_width_height", name: "Face Width to Height Ratio", category: "Facial Thirds", idealMin: 1.96, idealMax: 2.00, unit: "x", description: "Bizygomatic width to sellion-menton height ratio", isDetectable: true },
